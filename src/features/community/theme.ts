...
export const communityLightTheme: CommunityTheme = {
  ...
  community: {
    ...
    tabActiveIndicator: commonColors.navyDark,
    ...
    followBackground: commonColors.navyDark,
    ...
    bubbleMe: commonColors.navyDark,
    ...
    sendButton: commonColors.navyDark,
