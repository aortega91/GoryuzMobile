...
export const supportLightTheme: SupportTheme = {
  ...
  support: {
    ...
    adminResponseBg: commonColors.indigoSoft,
...
export const supportDarkTheme: SupportTheme = {
  ...
  support: {
    ...
    tabActiveText: commonColors.copperLight,
    tabActiveBorder: commonColors.copperLight,
    ...
    submitButtonBg: commonColors.copper,
    submitButtonText: commonColors.navyDark,
    attachButtonBg: commonColors.indigoLight,
    ...
    adminResponseLabel: commonColors.copperLight,
