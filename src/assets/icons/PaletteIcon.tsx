...
/**
 * Google Material Symbols `palette` (outlined, 24dp), path data verbatim from
 * google/material-design-icons — an artist's palette, for the colorimetry tab.
 *
 ...
 */
function PaletteIcon({ size = 24, color = '#000000' }: IconProps) {
  return (
