...
/**
 * Google Material Symbols `frame_person` (outlined, 24dp), path data verbatim
 * from google/material-design-icons — head and shoulders inside four corner
 * brackets, like a viewfinder framing someone.
 *
 ...
 */
function FramePersonIcon({ size = 24, color = '#000000' }: IconProps) {
  return (
